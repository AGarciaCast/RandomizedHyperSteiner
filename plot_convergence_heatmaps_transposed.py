...
for method in methods:
    ...
    # Create matrix for heatmap (TRANSPOSED: t values on y-axis, point numbers on x-axis)
    matrix = np.zeros((len(all_t_values), len(point_numbers)))
    matrix[:] = np.nan
...
for method in methods:
    print(f"Creating transposed plot for {method}...")
    ...
    # Add values on tiles (TRANSPOSED: i is t index, j is point number index)
